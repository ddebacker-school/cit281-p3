...
getCarMakeModelImplicit = (car) => `1 ${car.make} ${car.model}`;
console.log(getCarMakeModelImplicit(car));
...
getCarMakeModelExplicit = (car) => {
    return `2 ${car.make} ${car.model}`;
}
console.log(getCarMakeModelExplicit(car));
...
getCarMakeModelDestructure = () =>{
    let {make,model} = car;
    return `3 ${make} ${model}`
}
console.log(getCarMakeModelDestructure(car));
